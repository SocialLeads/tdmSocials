...
import { clientsApi, CreateClientData } from '../api/clients.api';
...
const AddClientModal: React.FC<Props> = ({ isOpen, onClose, onCreated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await clientsApi.create({ name, email, industry } as CreateClientData);
      setName('');
      setEmail('');
