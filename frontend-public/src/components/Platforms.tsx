  ...
  <section className="py-20 bg-white">
    <div className="max-w-6xl mx-auto px-6">
      ...
      <p className="text-center text-gray-500 mb-12">
        Each daily email includes one tailored content idea for each platform.
      </p>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
        {platforms.map((p) => (
          <div
            key={p.name}
            className={`text-center p-6 rounded-2xl border ${p.bg} transition-all shadow-sm hover:shadow-md`}
          >
